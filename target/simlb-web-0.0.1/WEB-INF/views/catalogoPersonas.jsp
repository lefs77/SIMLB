	        	 ...
	        	 <form class="form-horizontal"  id="registrarPersona-form">
	        		...
	        		<table id="idTablaRegistrarPersona">
	        			<tr>
	        				<td id="alerta-form-danger" style="display: none;">
	        		    	 ...
	        		    	 <td id="alerta-form-info">
	        		    		<div class="alert alert-info" role="alert"><b>Datos Generales</b></div>
	        		    	</td>
	        		    </tr> 
	        		    <tr>
	        		    	<td>
	        		    ...
	        		    <tr>
	        		 	...
	        		 	<tr>
	        		    	<td>        		    		        		    	
	        		    		<input type="text" class="form-control" id="nombre-form" placeholder="Primer Nombre" style="text-transform:uppercase;width:200px;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    	<td>        		    		        		    	
	        		    		<input type="text" class="form-control" id="nombre2-form" placeholder="Segundo Nombre" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    	<td>        		    		        		    	
	        		    		<input type="text" class="form-control" id="apellido-form" placeholder="Apellido Paterno" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    	<td>        		    		        		    	
	        		    		<input type="text" class="form-control" id="apellido2-form" placeholder="Apellido Materno" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    </tr> 
	        		    <tr>
	        		    	<td>
	        		     ...
	        		     <tr>
	        		    	...
	        		    	<td id="idCamposCliente" style="display: none;">
	        		    		<input type="text" class="form-control" id="claveCliente-form" placeholder="Clave Cliente" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    	<td id="idCamposEmpleado" style="display: none;">
	        		    		<input type="text" class="form-control" id="claveEmpleado-form" placeholder="Clave Empleado" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    	<td id="idCamposUsuario" style="display: none;">
	        		    		<input type="text" class="form-control" id="codigoUsuario-form" placeholder="Codigo Usuario" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">	        		    		
	        		    	</td>	        		   
	        		    	<td id="idCamposUsuario2" style="display: none; position:absolute;top:210px;right:32px;">
	        		    		<input type="text" class="form-control" id="puestoOcupado-form" placeholder="Puesto Ocupado" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" >
	        		    	</td>	
	        		    </tr> 
	        		    <tr>
	        		    	<td>
	        		    ...
	        		    <tr>
							...
							<td>        		    		        		    	
							      ...
							      <input type="text" class="form-control" id="codigoPostal-form" placeholder="Codigo Postal" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    ...
	        		    <tr>
	        		    	...
	        		    	<td>        		    		        		    	
	        		    		<input type="text" class="form-control" id="calle-form" placeholder="Calle" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
	        		    	</td>
	        		    </tr>
	        		     <tr>
	        		    	<td>
	        		    ...
	        		    <tr>	        		    	
	        		    	<td>        		    		        		    	
							      ...
							      <input type="text" class="form-control" id="numeroInt-form" placeholder="Numero Int."style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
							    
	        		    	</td>
	        		    	<td>        		    		        		    	
	        		    							      
							      <input type="text" class="form-control" id="numeroExt-form" placeholder="Numero Ext." style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
