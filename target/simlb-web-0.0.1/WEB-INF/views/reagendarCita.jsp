		...
		<div id="capaCuerpo3">
				...
				<div id="idBotonBsucar">
					<form id="searchbox" action="">
						<div id="posicionLabelParametros">Buscar por: <br>Fecha Agendada / Nombre  </div>
		    ...
		    <div class="content-popup">
        	 ...
        	 <form class="form-horizontal"  id="reagendarCita-form">
        		...
        		<table >
        		    ...
        		    <tr>
        		    	<td>        		    		        		    	
        		    		<input type="text" class="form-control" id="nombre-form" placeholder="Nombre" style="text-transform:uppercase; width:250px; height:30px;" onkeyup="javascript:this.value=this.value.toUpperCase();">
        		    	</td>
        		    	...
        		    	<td>        		    		        		    	
        		    		<input type="text" class="form-control" id="motivo-form" placeholder="Motivo" style="text-transform:uppercase;width:250px; height:30px;" onkeyup="javascript:this.value=this.value.toUpperCase();">
        		    ...
        		    <tr>
 					...
 					<tr>     
        		    	...
        		    	<td>		    														
							 <select id="hora-form2" name="hora-form2" style="width:265px; height:40px;" disabled>
